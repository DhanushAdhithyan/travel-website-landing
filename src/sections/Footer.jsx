      ...
      <div className="max-w-6xl mx-auto px-6 md:px-16 pt-20 pb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-14">
          ...
          <div className="col-span-2 md:col-span-1">
            <h2 className="text-3xl font-extrabold text-[#14213d] mb-3 tracking-tight">
              Jadoo.
            </h2>
          ...
          {/* Company */}
          <div>
            <h4 className="font-bold text-[#14213d] mb-4 text-[15px]">
              Company
            </h4>
            <ul className="space-y-3 text-sm text-gray-500">
              {["About", "Careers", "Mobile"].map((item) => (
                <li key={item}>
                  <a
                    href="#"
                    className="hover:text-[#E8604C] transition-colors duration-200"
                  >
                    {item}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <a
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #f9a825, #e91e8c, #6c3fe0)",
                }}
              >
                <svg
                  width="16"
            ...
            <div className="flex flex-col gap-2">
              <a
                href="#"
                className="flex items-center gap-2 bg-[#14213d] text-white rounded-lg px-3 py-2 w-fit hover:opacity-90 transition-opacity"
              >
                ...
                <div className="leading-tight">
                  <p className="text-[8px] opacity-75 uppercase tracking-wide">
                    Get it on
                  </p>
